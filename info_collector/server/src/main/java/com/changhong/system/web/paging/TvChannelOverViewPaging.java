 ...
 */
public class TvChannelOverViewPaging extends AbstractPaging<TvChannelInfoDTO> {
    ...
    public List<TvChannelInfoDTO> getItems() {
        return feedBackService.obtainAllTvChannelInfo(getStartPosition(), getPageSize(),channelName);
    }
