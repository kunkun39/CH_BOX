...
<div class="header">
    ...
    <div class="menu">
        ...
        <a href="${pageContext.request.contextPath}/backend/clientuserfeedbackoverview.html" <c:if test="${'FEEDBACK' eq BROSWER_LOCATION}">style="font-weight:bold;background:#5d5c5c;"</c:if>>用户反馈</a>

        <a href="${pageContext.request.contextPath}/backend/tvchannelinfooverview.html" <c:if test="${'COLLECTOR' eq BROSWER_LOCATION}">style="font-weight:bold;background:#5d5c5c;"</c:if>>用户收集</a>
