package com.changhong.touying.images;
...
public class DragImageView extends ImageView {
    ...
    public DragImageView(Context context, Activity activity) {
        super(context);
    ...
    public void setDragImageBitmap(int width, int height) {
        ...
        MIN_W = start_Right - start_Left;
        MIN_H = start_Bottom - start_Top;
        MAX_W = MIN_W * zoomSize;
        MAX_H = MIN_H * zoomSize;
    }
