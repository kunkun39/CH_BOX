...
public class SearchPageDefault extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        activity.findViewById(R.id.search_page_content).getViewTreeObserver().addOnGlobalLayoutListener(new OnGlobalLayoutListener() {
            @Override
    ...
    private View generalItem(Context context, String text) {
        ...
        view.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                FloatingActionButton searchButton = (FloatingActionButton) activity.findViewById(R.id.btn_search);
