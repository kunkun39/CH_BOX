...
//        m_pDialog.setProgress(0);
    ...
    private void initialEvents() {
        handler = new Handler() {
            ...
            public void handleMessage(Message msg) {
                ...
                switch (what) {
                    case 100:
                        Toast.makeText(getApplicationContext(), "恭喜您，已经是最新版本了", Toast.LENGTH_SHORT).show();
                        break;
                    case 200:
                        Toast.makeText(getApplicationContext(), "你没连接网络，请查看设置", Toast.LENGTH_SHORT).show();
                        break;
                    case 300:
                        //缺省
                        break;
                    ...
                    case 500:
                        ...
                        Toast.makeText(getApplicationContext(), "网络连接异常，请稍后重试", Toast.LENGTH_SHORT).show();
                        break;
                    case 600:
                        Toast.makeText(getApplicationContext(), "网络连接异常，请稍后重试", Toast.LENGTH_SHORT).show();
                        break;
    ...
    private void initData() {
         ...
         * 注册广播
         */
        updateService = new UserUpdateService(SettingActivity.this, handler, m_pDialog);
