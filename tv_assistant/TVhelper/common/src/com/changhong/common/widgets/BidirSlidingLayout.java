...
public class BidirSlidingLayout extends RelativeLayout implements
	...
	private String controllPack = "com.changhong.tvhelper";
	private String projectionPack = "com.changhong.touying";
	private String faqPack = "com.changhong.faq";
	private String settingPack = "com.changhong.setting";

	private String controllClass = "com.changhong.tvhelper.activity.TVRemoteControlActivity";
	private String TVClass = "com.changhong.tvhelper.activity.TVChannelShowActivity";
	...
	public void scrollToRightMenu() {
		...
		commonsidemenu.setVisibility(View.VISIBLE);
	}
	...
	protected void onLayout(boolean changed, int l, int t, int r, int b) {
		...
		if (changed) {
			...
			// leftMenuLayoutParams = (MarginLayoutParams)
			// leftMenuLayout.getLayoutParams();
			// 获取右侧菜单布局对象
			...
			LinearLayout menu_tv = (LinearLayout) findViewById(R.id.menu_tv);
			LinearLayout menu_touying = (LinearLayout) findViewById(R.id.menu_touying);
			LinearLayout menu_search = (LinearLayout) findViewById(R.id.menu_search);
			LinearLayout menu_shoucang = (LinearLayout) findViewById(R.id.menu_shoucang);
			LinearLayout menu_faq = (LinearLayout) findViewById(R.id.menu_faq);
			LinearLayout menu_setting = (LinearLayout) findViewById(R.id.menu_setting);
			Button menu_exit = (Button) findViewById(R.id.menu_exit);
			commonsidemenu = (ScrollView) findViewById(R.id.common_sidemenu);
			menu_controller.setOnClickListener(new OnClickListener() {

				@Override
				public void onClick(View v) {
					// TODO Auto-generated method stub
					startMenu(controllPack, controllClass);
				}
			});
			...
			menu_search.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					// TODO Auto-generated method stub
					startMenu(controllPack, searchClass);
				}
			});
			menu_shoucang.setOnClickListener(new OnClickListener() {

				@Override
				public void onClick(View v) {
					// TODO Auto-generated method stub
					startMenu(controllPack, collectionClass);
				}
			});
			menu_faq.setOnClickListener(new OnClickListener() {

				@Override
				public void onClick(View v) {
					// TODO Auto-generated method stub
					startMenu(controllPack, faqClass);
				}
			});
			menu_setting.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					// TODO Auto-generated method stub
					startMenu(controllPack, settingClass);
				}
			});
	...
	public boolean onTouch(View v, MotionEvent event) {
		...
		case MotionEvent.ACTION_DOWN:
			...
			xDown = event.getRawX();
			yDown = event.getRawY();
			Log.i("mmmm", "xDown=" + xDown + "|yDown=" + yDown + "|touchSlop="
					+ touchSlop);
			// 将滑动状态初始化为DO_NOTHING
	...
	private void checkLeftMenuBorder() {
		...
		// else if (contentLayoutParams.rightMargin <
		// -leftMenuLayoutParams.width) {
		// contentLayoutParams.rightMargin = -leftMenuLayoutParams.width;
		// }
	}
	...
	class RightMenuScrollTask extends AsyncTask<Integer, Integer, Integer> {
		...
		protected void onPostExecute(Integer leftMargin) {
			...
			contentLayout.setLayoutParams(contentLayoutParams);
			if (!isRightMenuVisible) {
				commonsidemenu.setVisibility(View.GONE);
			} 
		}
	}
	...
	public void startMenu(String strPack, String strClass) {
		Intent intent = new Intent();
		// intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK);
		// intent.setFlags(Intent.FLAG_ACTIVITY_REORDER_TO_FRONT);
//		 intent.setFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP);
		// intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
		intent.setClassName(strPack, strClass);
